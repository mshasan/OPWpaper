...
#'
#' @description Compute the relationship between the filter and test effect
#' sizes interms of the ranks probability of the filter given the test effect
#' sizes
#'
#' @param r Integer, rank of the filter statistics
#' @param rho Numerics, correlation between the filter and the test efect sizes
#' @param H0 Binary 0 or 1, determine null or alternative hypotheisis;
#' H0 = 0 for null and H0 = 1 for alternative
...
#' @param n_ey Integer, number of fiter-effects to be generated
#'
#' @details Compute the relationship between the filter and the test effect
#' sizes interms of the rankprobability of the filter given the test effect sizes.
#' The weight identity is based on the test effect size; however, the ranks
#' probability needs to compute from the filter effects. Therefore, it is
#' expected that there is a relationship between the filter and test effect sizes.
#'
...
#'
#' @return \code{prob} A numeric value of the rank probability of the filter
