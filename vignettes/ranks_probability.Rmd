...
# Ranks probability for the binary effects
Consider the similar set-up described for the continuous effects case. In addition, we considered the combination of the effect sizes $\{0\} \times \{0,1,2\}$, where $\{0\}$ represent the effect size of the null model and $\{0,1,2\}$ represents the effect sizes of the alternative models. Note that, for the binary case the alternative effects are the same.
